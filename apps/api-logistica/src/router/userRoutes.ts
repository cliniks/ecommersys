...
UserRouter.post("/addClient", (req: Request, res: Response) => {
  User.addClient(req, res);
});

UserRouter.post("/calculate", (req: Request, res: Response) =>
  User.calculateShipping(req, res)
);

UserRouter.post("/buy-shipping", (req: Request, res: Response) =>
  User.buyShipping(req, res)
);

UserRouter.get("/cart-items-info/:orderID", (req: Request, res: Response) =>
  User.cartItemsInfo(req, res)
);

UserRouter.post("/insert-cart-shipping", (req: Request, res: Response) =>
  User.insertCartShipping(req, res)
);

UserRouter.get("/list-cart", (req: Request, res: Response) =>
...
UserRouter.get("/info_user", (req: Request, res: Response) =>
  User.infoUser(req, res)
);

UserRouter.get("/credit", (req: Request, res: Response) =>
