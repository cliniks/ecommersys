import { MECalculateTagInfo, MECartProduct } from "../entities/melhor-envio.entitie";
...
export interface IUserCheckoutProvider {
  ...
  insertCartShipping({ service, agency, from, to, products, volumes, options }: InsetCartShippingProps): Promise<any>;
