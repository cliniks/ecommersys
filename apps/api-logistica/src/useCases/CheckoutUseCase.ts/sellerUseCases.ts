...
import { generateTagPropsType, ISellerCheckoutProvider } from "../../providers/ISellerCheckoutProvider";
...
export class SellerUseCases {
  constructor(private SellerProvider: ISellerCheckoutProvider, private UserProvider: IUserCheckoutProvider, private MailProvider: IMailSenderProvider) {}
  ...
  async uploadImageStore(req: any, res: Response) {
    try {
      ...
      const savePhone = await this.SellerProvider.uploadImageStore(storeID, file);
