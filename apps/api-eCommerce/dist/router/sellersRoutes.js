...
const sellerPoliciesRoutes_1 = require("./sellerPoliciesRoutes");
...
SellersRoutes.use("policies", sellerPoliciesRoutes_1.SellerPoliciesRoutes);
...
SellersRoutes.patch("/updateStoreBanner", upload.single("img"), SellersUseCases_1.sellersUseCases.updateStoreBanner);
