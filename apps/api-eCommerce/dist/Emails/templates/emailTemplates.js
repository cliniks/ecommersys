...
exports.SendCodeEmail = exports.ResetPasswordEmail = void 0;
const ResetPasswordEmail = ({ link, }) => `<!DOCTYPE html>
<html>
  <head>
...
const SendCodeEmail = ({ code }) => `<!DOCTYPE html>
<html>
  <head>
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
  ...
  >
    ...
    navigator.clipboard?.writeText && navigator.clipboard.writeText(code)
      alert("Código copiado para o Clipboard com sucesso!s")
    }
    </script>
  </body>
</html>
