...
exports.cartWithCouponApplied = void 0;
const cartWithCouponApplied = async (cart, couponRepo) => {
    var _a, _b;
    let totalPrice = 0;
    let totalDiscount = 0;
    ...
    if ((productItems === null || productItems === void 0 ? void 0 : productItems.length) > 0) {
        for (let couponId of coupons) {
            ...
            for (let i = 0; i < productItems.length; i++) {
                ...
                if (coupon.productsAssigned.length === 0 &&
                ...
                if (coupon.productsAssigned.find((item) => (item === null || item === void 0 ? void 0 : item.split("/")[0]) === productItems[i].productId)) {
                ...
                if (coupon.categoriesAssigned.filter((item) => categories.filter((category) => item.split("/")[0].includes(category)).length > 0).length > 0) {
                ...
                if (coupon.storesAssigned.find((item) => item.split("/")[0] === getProduct.owner)) {
...
exports.cartWithCouponApplied = cartWithCouponApplied;
