...
import { TextField, Divider, Card, Stack, Box, Autocomplete, Grid, IconButton, Drawer, styled, useTheme } from "@mui/material";
...
const jobsTags = [{ title: "QA Engineer" }, { title: "Team Lead" }, { title: "React Developer" }, { title: "Project Manager" }];
          ...
          >
            ...
            >
              <Autocomplete
                ...
                renderInput={(params) => <TextField {...params} fullWidth variant="outlined" label={t("Jobs Tags")} placeholder={t("Select tags...")} />}
              />
              <Autocomplete
                fullWidth
                multiple
                ...
                renderInput={(params) => <TextField {...params} fullWidth variant="outlined" label={t("Location")} placeholder={t("Select location...")} />}
              />
            </Stack>
          </Card>
        </Grid>
